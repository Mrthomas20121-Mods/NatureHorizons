...
public class AspenBoatItem extends Item {
    ...
    public AspenBoatItem(boolean hasChest) {
    ...
    /**
     * Gets a Boat dependent on {@link AspenBoatItem#hasChest}.
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return this.hasChest ? new AspenChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z) : new AspenBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z);
    }
}

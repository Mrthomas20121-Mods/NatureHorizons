...
import static mrthomas20121.nature_horizons.NatureHorizons.getResource;
import static net.minecraftforge.client.model.generators.ModelProvider.BLOCK_FOLDER;

public class NatureHorizonsBlockstateProvider extends BlockStateProvider {

    private final ModelFile.UncheckedModelFile GENERATED = new ModelFile.UncheckedModelFile("item/generated");

    public NatureHorizonsBlockstateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, NatureHorizons.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels() {
        ...
        addLeaveBlock(NatureHorizonsBlocks.AURIC_LEAVES.get(), blockTexture("wood/auric/leaves"));
        addSaplingBlock(NatureHorizonsBlocks.AURIC_SAPLING.get(), blockTexture("wood/auric/sapling"));
    ...
    public void axisBlock(Block block, String location, ResourceLocation texture, boolean horizontal) {
        ...
        ModelFile model = models().cubeColumn(NatureHorizons.resourceString(location), texture, endTexture);
        axisBlock((RotatedPillarBlock)block, model,
                horizontal ? models().cubeColumnHorizontal(NatureHorizons.resourceString(location + "_horizontal"), texture, endTexture) : model);
        simpleBlockItem(block, model);
    }

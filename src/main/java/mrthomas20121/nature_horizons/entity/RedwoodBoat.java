...
public class RedwoodBoat extends BaseBoat {

    public RedwoodBoat(EntityType<? extends Boat> p_38290_, Level p_38291_) {
        super(p_38290_, p_38291_);
    }

    public RedwoodBoat(Level level, double x, double y, double z) {
        this(NatureHorizonsEntityTypes.REDWOOD_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return NatureHorizonsItems.REDWOOD_BOAT.get();
    }

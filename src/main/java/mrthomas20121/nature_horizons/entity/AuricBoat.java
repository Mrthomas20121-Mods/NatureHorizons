...
public class AuricBoat extends BaseBoat {

    public AuricBoat(EntityType<? extends Boat> p_38290_, Level p_38291_) {
        super(p_38290_, p_38291_);
    }

    public AuricBoat(Level level, double x, double y, double z) {
        this(NatureHorizonsEntityTypes.AURIC_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return NatureHorizonsItems.AURIC_BOAT.get();
    }
